...
flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('imdong/flarum-ext-buy-doorman', function () {
  console.log('[imdong/flarum-ext-buy-doorman] Hello, admin!');
});
